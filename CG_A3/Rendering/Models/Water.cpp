...
void Water::Draw()
{
	...
	// Reflection Texture //
	int reflectionTexHandle = glGetUniformLocation(m_shader, "reflectionTex");
	glActiveTexture(GL_TEXTURE7);
	glBindTexture(GL_TEXTURE_2D, m_reflectedTexId);
	glUniform1i(reflectionTexHandle, 6);
...
void Water::reflectionTex()
{
	...
	//if (m_reflectedTexId > 0)
	//{
	//	glDeleteTextures(1, &m_reflectedTexId);
	//}

	glGenTextures(1, &m_reflectedTexId);
	glBindTexture(GL_TEXTURE_2D, m_reflectedTexId);
	int x, y, n;
	string texPath = "Rendering/Models/TestObjs/SkyBoxes/blueCloud/top.jpg";
